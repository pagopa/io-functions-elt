...
export const storeErrors =
  ...
  (
    storableErrors: readonly IStorableSendFailureError<unknown>[]
  ): readonly TE.TaskEither<Error, TableInsertEntityHeaders>[] =>
...
export const publish =
  ...
  (task: T.Task<readonly Validation<T>[]>): T.Task<IBulkOperationResult> =>
    pipe(
      task,
      T.bindTo("input"),
